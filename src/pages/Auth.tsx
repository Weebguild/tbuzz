                  ...
                  <AnimatePresence mode="wait" initial={false}>
                    {isLogin && !email.includes("@") && email.length > 0 ? (
                      <motion.div
                        ...
                        className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 flex items-center justify-center text-primary"
                      >
                      ...
                      <motion.div
                        ...
                        exit={{ opacity: 0, scale: 0.5 }}
                        transition={{ duration: 0.15 }}
                        className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 flex items-center justify-center text-muted-foreground"
                      >
