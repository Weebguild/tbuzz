  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        <div className={cn("px-6 pt-12", isMobile ? "" : "pb-6")}>
                    ...
                    >
                      <div className="relative group/avatar">
                        ...
                        <button
                          ...
                          className="absolute -top-1 -left-1 h-5 w-5 rounded-full bg-white text-black flex items-center justify-center opacity-0 group-hover/avatar:opacity-100 transition-opacity shadow-lg"
                        >
