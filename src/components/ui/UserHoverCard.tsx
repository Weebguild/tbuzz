...
export function UserHoverCard({ userId, children, className }: UserHoverCardProps) {
    ...
    return (
        <HoverCard openDelay={350} closeDelay={200} onOpenChange={(open) => {
            ...
            <HoverCardContent
                className="w-96 bg-[#0A0A0A]/95 backdrop-blur-2xl border border-white/[0.08] shadow-[0_24px_80px_-12px_rgba(0,0,0,0.8),0_0_40px_-8px_rgba(124,58,237,0.15)] p-0 overflow-hidden rounded-2xl"
                side="top"
                align="start"
                sideOffset={8}
            >
